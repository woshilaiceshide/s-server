...
//!!!which inspects callers' stack traces.
//!!!in scala-2.11.8, if the following trait is replaced by 'object BasicRules extenss Parser { ... }', the stack trace will be reduced by 1.
//!!!as a workaround, make an 'object Basic Rules' based on 'trait BasicRules'.
private[parser] trait BasicRules extends Parser {
