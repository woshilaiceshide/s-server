 ...
 */
final class HttpHeaderParser private (val settings: spray.can.parsing.ParserSettings,
...
object HttpHeaderParser {
  ...
  def apply(settings: spray.can.parsing.ParserSettings, warnOnIllegalHeader: ErrorInfo ⇒ Unit = defaultIllegalHeaderWarning,
